 ...
 */
public class M2XCreateHRTrigger extends Request {
    ...
    public M2XCreateHRTrigger(final ResponseListener responseListener, final String deviceId, int condition, final String triggerName, final String familyId) {
