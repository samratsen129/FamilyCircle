 ...
 */
public class M2XCreateTemperatureTrigger extends Request {
    ...
    public M2XCreateTemperatureTrigger(final ResponseListener responseListener, final String deviceId, int condition, final String triggerName, final String familyId) {
