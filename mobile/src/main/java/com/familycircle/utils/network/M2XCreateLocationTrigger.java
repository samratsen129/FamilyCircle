 ...
 */
public class M2XCreateLocationTrigger extends Request {
    ...
    public M2XCreateLocationTrigger(final ResponseListener responseListener, final String deviceId, final String triggerName, final String familyId) {
