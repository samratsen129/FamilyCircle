 ...
 */
public class M2XCreateDoorTrigger extends Request {
    ...
    public M2XCreateDoorTrigger(final ResponseListener responseListener, final String deviceId, final String triggerName, final String familyId) {
